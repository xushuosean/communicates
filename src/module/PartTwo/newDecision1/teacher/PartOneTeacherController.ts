class PartTwoTeacherController1 extends BaseController {
  ...
  constructor() {
    ...
    App.ViewManager.register(ViewConst.partTwoTeacher1, this.PartTwoTeacherView);
  ...
  private changeLabel(args): void {
    ...
    let mood = App.ControllerManager.applyFunc(ControllerConst.partTwoNPC, PartTwoNPCConsts1.getMood)
    CommonInit.initTalk({
      text: args.content,
      hrSource: mood,
      animation: false
