class PartTwoLongTapView extends DDI.MiddleBaseLongTap {
  ...
  public ToNext(mask: eui.Rect, ct: eui.Group): void {
        ...
        // 并更改optionDesc
        App.ControllerManager.applyFunc(ControllerConst.PartTwoRepeat, PartTwoRepeatConsts.changeLabel, ct["_data"].optionDesc )
  }
